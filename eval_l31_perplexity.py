...
def main():
    print("=" * 60)
    print(f"L31 Degradation Eval: last-token perplexity on WikiText-2")
    print(f"Seeds: {SEEDS}, op: {OP}")
    print("=" * 60)
    ...
    for seed in SEEDS:
        ...
        print(f"  Alpha sweep (last-token loss at L{PATCH_LAYER})...")
        results = []
        for alpha in ALPHAS:
        ...
        path = f"{OUT_DIR}/perplexity_sweep_seed{seed}.csv"
